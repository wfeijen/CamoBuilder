...
file_name_met_tekst = '/home/willem/Pictures/Camouflage/camoBuilder/camoOutput/colorCard_rb_tekst.jpg'
file_name_zonder_tekst = '/home/willem/Pictures/Camouflage/camoBuilder/camoOutput/colorCard_rb_zonder_tekst.jpg'
N = 9
square_size = 200
font_size = 28
...
def maak_color_card(N, square_size, font_size, tekst=False):
    ...
    image_width = N * square_size
    image_height = N * square_size
    ...
    for r in count:
            for b in count:
                color = (int(r*factor), 0, int(b*factor))
