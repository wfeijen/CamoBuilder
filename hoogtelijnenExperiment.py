...
blotter = PerlinBlotter(persistence, lacunarity, octaves, scaleX, scaleY, versie, 0)
blot = blotter.blotVierkant_genormaliseerde_waarden(blot_sizeX=breedte, blot_sizeY=hoogte)
