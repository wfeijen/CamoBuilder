...
punt_randomisatie_X = topoGenerator.genereer_1(
    Id = "P1",
    noise_type="simplex",
    octaves=4,
    persistence=0.8,
...
punt_randomisatie_Y = topoGenerator.genereer_1(
    Id = "P2",
    noise_type="simplex",
    octaves=4,
    persistence=0.8,
...
# 	Id	Glob1	noise	simplex	o	4	per	0.8	lan	4	scaleX	100	scaleY	30	versie	3	macht	1	bereik	1
...
# Id	Glob2	noise	simplex	o	4	per	0.8	lan	4	scaleX	200	scaleY	70	versie	4	macht	3	bereik	1	
topografieGlobaal += topoGenerator.genereer_1(
    Id = "Glob2",
    noise_type="simplex",
    octaves=4,
...
# Id	Lok1	noise	simplex	o	3	per	0.8	lan	4	scaleX	70	scaleY	30	versie	5	macht	3	bereik	1	
...
# Id	Lok2	noise	simplex	o	4	per	0.8	lan	2	scaleX	20	scaleY	70	versie	8	macht	3	bereik	1	
topografieLokaal += topoGenerator.genereer_N(
    N=canvasGenerator.aantal_globale_kleurgroepen,
    Id = "Lok2",
    noise_type = "simplex",
...
picture.create_vonoroi(schaal_X=40, schaal_Y=40, randomfactor_X=30, randomfactor_Y=30)
#
# picture.show()
